...
/* Macro: BE_DIRROOT
 * Specification of the root directory within the filesystem.
 */
/* Macro: BE_DIRSEP
 * Specification of the directory separator within the filesystem.
 */
/* Macro: BE_EXTSEP
 * Specification of the extension separator within the filesystem.
 */
/* Macro: BE_DIRPARENT
 * Specification of the parent directory within the filesystem.
 */
#ifdef __riscos
#define BE_DIRROOT      '$'
#define BE_DIRSEP       '.'
